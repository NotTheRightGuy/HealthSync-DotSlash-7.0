...
export default function DiagnosisCard(props){
    ...
    return(
        <div className="bg-[#0f0f11] rounded-3xl border-[1px] border-[#52525c] p-5 pr-10 flex flex-col gap-3">
            ...
            <div className="ml-2 h-36 flex flex-col justify-between">
                <div>
                    ...
                    <div className="nameOfIll flex gap-3 mt-2">
                        {
                            props.priorIllness.map((illness) => {
                                return(
                                    <div className="nameOfIllness border-2 border-[#52525c] opacity-65 px-4 py-2 rounded-full text-xs">{illness}</div>
                                )
                            })
                        }
                    </div>
