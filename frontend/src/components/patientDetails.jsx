    ...
    return (
        <div className="h-5/6 w-screen p-10 flex gap-[72px]">
            ...
            <div className="text-3xl opacity-90 font-medium w-3/12">
                Prescription
                <div className="h-4/6 mt-5 w-full bg-[#0c0c0c] border-2 border-[#52525c] rounded-xl"></div>
            </div>
            <div className="flex flex-col gap-4">
                <div className="text-3xl opacity-90 font-medium">
                    ...
                    <li className="font-inter text-sm opacity-65 mt-2">
                        {" "}
                        Pain Behind Eyes{" "}
                    </li>
                    <li className="font-inter text-sm opacity-65 ">
                        {" "}
                        Skin Rashes{" "}
                    </li>
                ...
                <div className="text-2xl">
                    ...
                    <div className="flex gap-6 items-center mt-3">
                        <div className="flex items-center">
                            ...
                            />
                            <span className="text-base ml-2 opacity-65">
                                Yes
                            </span>
                        </div>
                        <div className="flex items-center">
                            <input
                                ...
                                className=" w-4 h-4"
                                onClick={(e) => {
                                    setModelInCorrection(!modelInCorrection);
                ...
                {modelCorrection ? (
                    <div className="flex flex-col">
                        Additional Remarks
                        <textarea
                            className="bg-transparent border-2 border-[#52525c] rounded-xl"
                            name=""
                            id=""
                            cols="40"
                            rows="5"
                            onChange={(e) => setDoctorsRemark(e.target.value)}
                        ></textarea>
                    </div>
                ) : null}
                {modelInCorrection ? (
                    <div className="-translate-y-2">
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="flex gap-1">
                                <div className="text-sm opacity-85 mr-16">
                                    Disease
                                </div>
                                <input
                                    type="text"
                                    className="border-2 border-[#52525c] bg-transparent rounded-xl w-1/2"
                                    onChange={(e) =>
                                        setCorrectDiagnosis({
                                            ...correctDiagnosis,
                            ...
                            <div className="flex gap-1">
                                <div className="text-sm opacity-85 mr-2">
                                    Confidence Level
                                </div>
                                <input
                                    type="text"
                ...
                <div
                    className="border-2 border-[#52525c] p-2 w-2/6 text-center rounded-full absolute right-10 bottom-10 hover:border-white cursor-pointer "
