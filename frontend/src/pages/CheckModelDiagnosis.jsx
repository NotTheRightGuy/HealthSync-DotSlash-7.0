...
const CheckModelDiagnosis = () => {
    ...
    function generatePrescription() {
        ...
        const messageToSend = `My patient is suffering from ${diag.disease}. Your task is to give the medicines used to cure it and the precautions one need to take. Don't give any other reply apart from this. Be specific with the medicine names\nStrictly follow the format as such\nMedcines\n(all the medicines)\n\nPrecautions\n(all the precautions one need to take). Be concise and only provide 3-4 points.`;
        axios
