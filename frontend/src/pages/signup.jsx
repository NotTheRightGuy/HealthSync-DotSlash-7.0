    ...
    return(
        <div className=''>
            <div className='flex w-screen h-screen'>
                        ...
                        <div className='flex justify-between text-xs '>
                            <a href="/signup">
                                <div className='opacity-60 hover:opacity-100'>
                                    Already have an account ? <span className='underline underline-offset-4 cursor-pointer'>Login</span>
                                </div>
                            </a>
                ...
                <div className="w-7/12 bg-[#1a1a1d] h-screen p-12 flex flex-col justify-between">
                    <a href="/">
